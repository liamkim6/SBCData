...
| 경로 | 내용 |
|---|---|
| [docs/planning/2026-07-week1-product-planning.md](docs/planning/2026-07-week1-product-planning.md) | **이번 주** 주간 프로덕트 플래닝 초안 (2026년 7월 1주차, 7/6–7/12) |
...
- 주간 플래닝 파일명: `docs/planning/YYYY-MM-weekN-product-planning.md` (예: `2026-07-week1` = 7월 1주차. 매주 초안 작성 → 비동기 릴레이로 확정)
